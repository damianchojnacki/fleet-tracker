      ...
      <div className="py-12 px-1">
        <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
          ...
          <div className="flex justify-between items-center px-2 py-4">
            <h1 className="font-semibold text-primary">Latest trips</h1>
            <Link className="flex items-center gap-2 font-semibold text-primary hover:underline hover:text-primary/[0.8]" href="/trips/create">
              <span>New trip</span>
