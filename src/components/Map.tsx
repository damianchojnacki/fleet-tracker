...
const Map: React.FC = () => {
    ...
    function MyLocation()
    {
        return (
            <div className=' z-50 fixed bottom-28 left-4'>
                <svg xmlns='http://www.w3.org/2000/svg' fill='rgb(15, 23, 41)' height='30' width='30'
    ...
    return (
        <div className='my-3'>
            <MyLocation />
            <SheetBar />
            <MapContainer center={[52.22, 21.01]} zoom={13}
                          className='absolute top-0 left-0 h-[calc(100vh-64px-80px)] xs:h-[calc(100vh-64px-56px)] w-full z-10'
                          zoomControl={false}
            >
                <TileLayer
