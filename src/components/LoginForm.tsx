        ...
        <TabsContent value='account'>
            <Card className='w-full border-secondary text-primary-foreground'>
                <form onSubmit={submitSignInForm}>
                    <CardHeader>
                        <CardDescription className='font-semibold'>Enter your email address and password to Sign
                            In</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <div className='grid w-full items-center gap-4'>
                            <div className='flex flex-col space-y-1.5'>
                                ...
                                <Input type='email' value={email} id='email' placeholder='example@fleet-tracker.com'
                                       className='border-secondary  ' onChange={event => setEmail(event.target.value)}
                                       required autoFocus
                                />
                            ...
                            <div className='flex flex-col space-y-1.5'>
                                ...
                                <Input type='password' value={password} required autoComplete='current-password'
                                       id='password' placeholder='password' className='border-secondary'
